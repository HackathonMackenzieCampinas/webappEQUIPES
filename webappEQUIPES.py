...
if choice == "Dúvidas": 
  ...
  with colNotas3:
    ...
    st.markdown("<h1 style='text-align: center; color: gray;'>Este painel tem o objetivo de auxiliar a Equipe de Gestão do Hackathon 2023 escolher as 5 equipes finalistas que participarão do Evento Final, disputando uma das três vagas na dinâmica Elevator Pitch</h1>", unsafe_allow_html=True)
